...
public class GuiClickEvent extends InventoryClickEvent {
    ...
    public GuiButtonInterface getClickedButton() {
        ...
        if (getView().getTopInventory().getHolder() instanceof eu.xap3y.xagui.GuiMenu) {
            eu.xap3y.xagui.GuiMenu menu = (eu.xap3y.xagui.GuiMenu) getView().getTopInventory().getHolder();
